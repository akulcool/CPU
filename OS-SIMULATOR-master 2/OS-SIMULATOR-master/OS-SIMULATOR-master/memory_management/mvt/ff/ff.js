...
function startColumn2() {
    var htmlText = 
    `
    <button type="submit" class="btn btn-primary" id="add-pro-btn" style = " background-color: #ff9dbd;">Add process</button>
    <button type="submit" class="btn btn-primary" id="rem-pro-btn" style = " background-color: #ff9dbd;">Remove process</button>
    `;
...
function addProcessSize() {
    ...
    <button type="submit" class="btn btn-primary" id="add-btn" style = " background-color: #ff9dbd;">Add</button>
    `;
...
function remProcessId() {
    ...
    <button type="submit" class="btn btn-primary" id="rem-btn" style = " background-color: #ff9dbd;">Remove</button>
    `;
    $("#add-rem-pro").html(htmlText);
    $(document).ready(function() {
...
function drawInputQTable() {
    var htmlText = 
    `
    <button type="submit" class="btn btn-primary md-3" id="compact-btn" style = " background-color: #ff9dbd;">Calculate Fragmentation</button> 
    <table>
    <tr>
