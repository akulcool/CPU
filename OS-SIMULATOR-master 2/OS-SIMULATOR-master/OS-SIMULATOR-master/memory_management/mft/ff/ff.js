...
function displayPartSize() {
    ...
    htmlText += 
    `
    <button type="submit" class="btn btn-primary" id="parts-size-btn" style="background-color: pink;">Go</button>
    `;
...
function startColumn2() {
    var htmlText = 
    `
    <button type="submit" class="btn btn-primary" id="add-pro-btn" style="background-color: pink;">Add process</button>
    <button type="submit" class="btn btn-primary" id="rem-pro-btn" style="background-color: pink;">Remove process</button>
     <button type="submit" class="btn btn-primary" id="fr-pro-btn" style="background-color: pink;">Calculate Fragmentation</button>
...
function addProcessSize() {
    ...
    <button type="submit" class="btn btn-primary" id="add-btn"style="background-color: pink;">Add</button>
    `;
...
function calcExtFrag(pro_size) {
    ...
    for(i = 0; i < num_parts; i++) {
       if(pro[i]){
       tot_hole_size = tot_hole_size +(part_size[i]-pro[i]);
   }
   else{
     tot_hole_size = tot_hole_size + part_size[i];
   }
    ...
    if(tot_hole_size > pro_size) {
        alert("Total Internal Fragmentation is " + tot_hole_size);
